...
func NewRpcAdapter(clientV06 *ClientV06, debug *Debug) *RpcAdapter {
	return &RpcAdapter{clientV06, debug}
}
...
func (r *RpcAdapter) Eth_sendUserOperation(op userOperation, ep string) (string, error) {
	return r.clientV06.SendUserOperation(op, ep)
}
...
func (r *RpcAdapter) Eth_estimateUserOperationGas(
	...
	return r.clientV06.EstimateUserOperationGas(op, ep, os)
}
...
func (r *RpcAdapter) Eth_getUserOperationReceipt(
	...
	return r.clientV06.GetUserOperationReceipt(userOpHash)
}
...
func (r *RpcAdapter) Eth_getUserOperationByHash(
	...
	return r.clientV06.GetUserOperationByHash(userOpHash)
}
